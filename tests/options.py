def pytest_addoption(parser):
    ...
    parser.addoption(
        '--user', action='store', dest='username', type=str, default='HQ\GLKU-SUDIR-User1', help='Username'
    )
    parser.addoption(
        '--password', action='store', dest='password', type=str, default='nHrht9IGxPfjqoFCqJwg!!', help='Password'
    )
