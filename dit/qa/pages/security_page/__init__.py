    ...
    def wait_for_loading(self) -> None:
        def condition() -> bool:
            try:
                ...
                assert 'Безопасность' in self.header.breadcrumbs
                assert 'Пользователи' in self.header.breadcrumbs
                assert self.header.create_users
                ...
                assert self.navigation.organizations.visible
                assert self.navigation.settings.visible
                assert self.navigation.history.visible
